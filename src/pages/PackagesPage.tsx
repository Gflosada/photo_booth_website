...
export default function PackagesPage() {
  return (
    <div className="min-h-screen bg-black pt-32 pb-24">
      <SEO title="Orlando Photo Booth Packages | Lumea Booth" description="Compare Lumea Booth Orlando photo booth packages for classic booths, premium events, 360 video booth experiences, weddings, parties, and corporate activations." path="/packages" />
