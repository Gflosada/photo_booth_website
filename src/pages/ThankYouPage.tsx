  ...
  return (
    <div className="min-h-screen bg-black pt-32 pb-24 flex items-center">
      ...
      <div className="max-w-3xl mx-auto px-4 text-center">
        <CheckCircle2 className="w-20 h-20 text-[#F5D76E] mx-auto mb-6" />
        ...
        <Button asChild className="opbe-btn-primary rounded-full px-8 py-6"><Link to="/">Back to Home</Link></Button>
      </div>
    </div>
  );
}
