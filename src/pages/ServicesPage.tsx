...
export default function ServicesPage() {
  ...
  return (
    <>
      <SEO title="Orlando Photo Booth Services | Weddings, 360 Booths, Corporate Events" description="Explore Lumea Booth photo booth services in Orlando, including wedding photo booths, 360 video booths, corporate activations, glam booths, and custom backdrops." path="/services" />
