    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "size-7 border-white/10 bg-transparent p-0 text-white opacity-100 hover:bg-white/10 hover:text-white disabled:opacity-40",
        ),
        ...
        day_today: "bg-transparent text-[#F5D76E] hover:bg-white/10 hover:text-[#F5D76E]",
        day_outside:
