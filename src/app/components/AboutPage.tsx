        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-white/70 text-lg">
              <p>
                Founded in 2022, Lumea Booth started with a simple mission: to make every celebration
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScaleOnScroll>
          ...
          <p className="text-white/90 text-lg mb-8">
            ...
            When you choose Lumea Booth, you're supporting a local business that cares about our community.
          </p>
