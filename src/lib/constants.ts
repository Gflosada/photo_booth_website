export const SITE_NAME = 'Oralndo Ohiti Booth Events';
...
export const BUSINESS_EMAIL = import.meta.env.VITE_PUBLIC_BUSINESS_EMAIL || 'hello@oralndoohitiboothevents.com';
